...
public class SuiteOneCaseOne extends SuiteOneBase{
	...
	public void SuiteOneCaseOneTest(String DataCol1,String DataCol2,String DataCol3, String DataCol4, String DataCol5, String DataCol6, String DataCol7, String DataCol8, String ExpectedResult){
		...
		driver.findElement(By.xpath("id('entry_1000013')")).sendKeys(DataCol2);
		driver.findElement(By.xpath("id('entry_1000014')")).sendKeys(DataCol3);
		//getElementByID("entry_1000014")
		...
		driver.findElement(By.xpath("id('entry_1000002')")).sendKeys(DataCol4);
		driver.findElement(By.xpath("id('entry_1000003')")).sendKeys(DataCol5);
		driver.findElement(By.xpath("id('entry_1000004')")).sendKeys(DataCol6);
		driver.findElement(By.xpath("id('entry_1000005')")).sendKeys(DataCol7);
		...
		driver.findElement(By.xpath("id('entry_1000009')")).sendKeys(DataCol8);
		...
		//driver.findElement(By.xpath("id('mp-other')/ul/li[1]/b/a")).click();
		//getElementByName("Community portal").click();
		//driver.get(Param.getProperty("siteURL"));
		//driver.findElement(By.xpath("id('mp-sister')/table/tbody/tr[1]/td[2]/b/a")).click();
		//getElementByName("Commons").click();my Work
