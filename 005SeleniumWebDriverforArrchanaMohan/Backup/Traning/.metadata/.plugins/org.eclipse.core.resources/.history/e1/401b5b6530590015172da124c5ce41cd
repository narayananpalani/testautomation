...
public class SuiteOneCaseOne extends SuiteOneBase{
	...
	public void SuiteOneCaseOneTest(String DataCol1,String DataCol2,String DataCol3,String ExpectedResult){
		...
		//Call static getElementByXPath function with element's object key from SuiteBase class to get element object.
		getElementByXPath("txt_Result").clear();
		...
		//Call dynamic getElementByXPath function with element's xPath part1 key, Variable value and element's xPath part2 key from SuiteBase class to get element object.
		...
		getElementByXPath("btn_Equals").click();
		
		String Result = getElementByXPath("txt_Result").getAttribute("value");
